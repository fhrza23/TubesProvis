...
// import 'package:flutter/material.dart';
// import 'package:provider/provider.dart';
// import 'provider/daftar_provider.dart'; // Impor DaftarProvider
// import 'daftar_2.dart';
...
//   // Buat instance DaftarProvider
//   DaftarProvider _daftarProvider = DaftarProvider();
...
//     // Check NIK
//     try {
//       final nikExists = await _daftarProvider.checkNik(nik); // Menggunakan DaftarProvider
//       print('NIK is available: $nikExists');
//       if (!nikExists) {
//         // ScaffoldMessenger.of(context).showSnackBar(
//         //   SnackBar(content: Text('NIK sudah terdaftar, silakan gunakan NIK lain.')),
...
//     // Simpan data ke DaftarProvider
//     _daftarProvider.setNik(nik);
//     _daftarProvider.setNama(namaController.text);
//     _daftarProvider.setTglLahir(tglLahirController.text);
